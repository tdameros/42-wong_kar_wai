...
static void play_all_move(t_engine *engine, int32_t start, int8_t way, t_move move);
static void join_all_move(t_engine *engine, int32_t start, int8_t way, t_move move);

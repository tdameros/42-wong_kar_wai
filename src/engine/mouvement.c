...
static uint8_t play_horizontaly_move(t_engine *engine, int32_t start,
                                     int32_t way);
static uint8_t play_verticaly_move(t_engine *engine, int32_t start,
                                   int32_t way);
static uint8_t join_horizontaly_move(t_engine *engine, int32_t start,
                                     int32_t way);
static uint8_t join_verticaly_move(t_engine *engine, int32_t start,
                                   int32_t way);
...
bool can_play(t_engine *engine) {
  ...
  return (can_join_horizontaly(engine, 0, 1) ||
          can_join_horizontaly(engine, engine->grid_size - 1, -1) ||
          can_join_verticaly(engine, 0, 1) ||
          can_join_verticaly(engine, engine->grid_size - 1, -1));
}
